        ...
        <div className="flex">
          ...
          <div className="flex-1 p-4 space-y-2">
            <div className="flex items-center gap-2">
              <span className="text-xs text-amber-400 font-medium">{formatDate(item.featuredDate)}</span>
              {item.selectedBy === 'admin' && (
                <span className="text-[10px] px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-500">Pick</span>
              )}
            </div>
