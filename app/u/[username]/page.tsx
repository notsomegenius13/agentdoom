      ...
      <div className="border-b border-gray-800 bg-doom-dark/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/creators" className="text-sm text-gray-400 hover:text-white transition-colors">
              Top Creators
            </Link>
        ...
        >
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {profile.isVerified && (
                <span className="text-doom-accent text-sm" title="Verified">✓ Verified</span>
              )}
              {profile.isPro && <ProBadge size="md" />}
            </div>
            <p className="text-sm text-gray-500">@{profile.username}</p>
            {profile.bio && (
              <p className="mt-2 text-gray-400 max-w-xl">{profile.bio}</p>
            )}
